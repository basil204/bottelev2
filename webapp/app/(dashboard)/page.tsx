...
import {
  ArrowClockwise, ArrowRight, ChartLineUp, CheckCircle, Cpu, Database,
  EnvelopeSimple, HardDrives, Package, Receipt, ShoppingCart, TrendUp,
  Users, Wallet, WarningCircle,
