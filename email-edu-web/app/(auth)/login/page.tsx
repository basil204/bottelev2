        ...
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-background">
            ...
            <div className="relative z-10 w-full max-w-md p-8 md:p-10">
                ...
                <div className="relative z-20 flex flex-col items-center">
                    ...
                    {/* Error Message */}
                    {error && (
                        <div className="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20 text-red-500 text-sm text-center w-full">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="mt-8 text-center text-sm text-muted-foreground">
                        <span>Liên hệ Admin để được cấp tài khoản</span>
                    </div>
                </div>
            </div>
        </div>
